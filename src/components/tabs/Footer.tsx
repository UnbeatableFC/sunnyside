...
export function Footer() {
  return (
    <div className="bg-green-400/40 flex flex-col gap-5 justify-center items-center py-10 md:py-20">
      ...
      <div className="flex items-center gap-6 text-green-700 hover:text-white cursor-pointer">
        <div>
          <svg
            width="20"
            height="20"
            ...
            fill="currentColor"
            className="text-[#2C7566] hover:text-white transition-colors duration-200"
          >
            <path
